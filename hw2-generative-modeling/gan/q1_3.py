...
def compute_discriminator_loss(
    ...
    # for Q1.5.
    ##################################################################
    l1 = F.binary_cross_entropy_with_logits(discrim_real, torch.ones_like(discrim_real))
    l2 = F.binary_cross_entropy_with_logits(discrim_fake, torch.zeros_like(discrim_fake))
    loss = l1 + l2
    ##################################################################
    #                          END OF YOUR CODE                      #
    ##################################################################
